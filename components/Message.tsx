...
function Message({ message }: Props) {
  ...
  return (
    <div className="flex gap-2">
      <div>
        <Image src={message.user?.avatar_url!} alt={message.user?.display_name!} width={40} height={40} className=" rounded-full ring-2" />
      </div>
      <div className="flex-1">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            <h1 className="font-bold">{message.user?.display_name}</h1>
